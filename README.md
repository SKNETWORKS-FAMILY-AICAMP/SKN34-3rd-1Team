...
실제 API 실행에서 후보 누락을 확인해 요청별 출력 개수 제약을 보강했습니다. 이후 응답의 총점·자격 점수
모순으로 캡처가 중단됐으며 [실제 실행 및 남은 오류](evaluation/support-program-search/runs/support-program-catalog-20260906-v1/actual-capture-v1/README.md)에
API 없이 재현할 수 있는 근거를 보관했습니다. 기존 AI 판정을 실제 캡처의 새 후보 풀로 이전하는 도구도 추가했습니다.
